...
| **Репо `kb/add/`** | `02_prompt_ocr_v1.txt`, `02_prompt_reconciliation_v3.5.txt`, `02_prompt_diagnostics_v3.1.txt` | Долгосрочный снапшот для diff между версиями. |
| **Claude Project knowledge** | `02_prompt_ocr_v1.txt`, `02_prompt_reconciliation_v3_5.txt`, `02_prompt_diagnostics_v3_1.txt` | Upload для self-contained reference. Подчёркивания вместо точек — особенность Project upload. |
...
- System prompt: см. `add/02_prompt_ocr_v1.txt`.
...
Полный текст: `add/02_prompt_reconciliation_v3.5.txt`.
...
Полный текст: `add/02_prompt_diagnostics_v3.1.txt`.
...
**Пачечная ветка (модуль 196) — `add/02_make_line_log_pack.txt`:**
```
...
**Штучная ветка (модуль 219) — `add/02_make_line_log_unit.txt`:**
```
...
- `add/02_prompt_ocr_v1.txt`, `add/02_prompt_reconciliation_v3.5.txt`, `add/02_prompt_diagnostics_v3.1.txt` — production prompts.
- `add/02_make_line_log_pack.txt`, `add/02_make_line_log_unit.txt` — Make.com line-log шаблоны.
