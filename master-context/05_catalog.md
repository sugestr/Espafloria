...
**Что в файле:** migration toolkit v2.2 (UI trigger + execute + automation), 4 правила миграции (бывшие §20-23 в старом 99), category tree, ID-registry мигрированных карточек, validation matrix, post-migration procedures, rollback. Структуры карточек и кастомные поля Holded — здесь же.

**Status:** 🟢 PROD — 10 карточек мигрировано (6 deliveries + 4 цветка), 100% success на тестах.
...
## 8. ID Registry — 10 мигрированных карточек (2026-04-19)

### 8.1. Deliveries (все flat→flat, categ 286)

| Source | SKU | → | Target tmpl | Target variant | Name | Sales | Cost |
|---|---|---|---|---|---|---|---|
