...
В корне репо лежит короткий stub-[`README.md`](../README.md) — он нужен только для GitHub-лендинга. Настоящая база — эта папка.
...
│   (короткий stub — пойнтер на master-context/)
└── master-context/                              ← ВСЁ живёт тут
    ├── README.md                                (этот файл)
...
Полный worker-протокол (стадии, sandbox-delivery, commit-скрипт) — в [`12_ai_workflow.md`](12_ai_workflow.md).
