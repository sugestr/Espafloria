...
| `VERSIONS.md` | 18 | 2026-04-23T13:50Z |
| `SYNC_STATE.md` | 10 | 2026-04-19T22:15Z |
| `CHANGELOG.md` | 18 | 2026-04-23T13:50Z |
| `00_master_index.md` | 12 | 2026-04-23T01:40Z |
| `00_source_files_index.md` | 6 | 2026-04-19T12:30Z |
| `01_business_context.md` | 5 | 2026-04-23T01:40Z |
...
| `05_florists_logistics_accountant.md` | 6 | 2026-04-23T13:45Z |
...
| `09_open_work.md` | 8 | 2026-04-23T01:40Z |
...
| `99_invariants.md` | 7 | 2026-04-23T13:40Z |
| `claude_session_feedback.md` | 1 | 2026-04-23T16:35Z |
...
- `bouquet_on_payment_action.py` — Odoo server action id=1203 v2 (POS→SO create/reassemble/sell, reserve-model)
- `bouquet_on_dismantle_action.py` — Odoo server action id=1209 (dismantle via method=8)
- `bouquet_on_picking_action.py` — DEPRECATED v1 (action 1205, automation 11 disabled — оставлен на случай отката)
- `bouquet_on_order_paid_action.py` — DEPRECATED v1 (action 1207, automation 12 disabled — оставлен на случай отката)
