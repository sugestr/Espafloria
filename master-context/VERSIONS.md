...
Все `.md` и почти все артефакты живут в `master-context/` на одном уровне. Только `legacy_migrations/` — в подпапке. `README.md` — в корне репо.
...
| Файл | v | Updated (UTC) |
|---|---|---|
| `README.md` *(repo root)* | 5 | 2026-04-18T23:00Z |
| `VERSIONS.md` | 8 | 2026-04-18T23:00Z |
| `SYNC_STATE.md` | 7 | 2026-04-18T23:00Z |
| `CHANGELOG.md` | 9 | 2026-04-18T23:00Z |
...
| `12_ai_workflow.md` | 6 | 2026-04-18T23:00Z |
...
- `legacy_migrations/` — одноразовые Holded-миграции (`image_import_from_holded_api.py`, `image_import_from_urls.py`, `split_big_csv.py`); читать локально при необходимости
