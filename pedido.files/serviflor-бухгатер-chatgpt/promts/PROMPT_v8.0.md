...
Optional helper column only if clearly marked DO NOT MAP:
- uom_display_ignore
...
- uom_display_ignore must not map.
...
- Unit / Database ID follows safe purchase representation:
  - unit item = Units;
...
Operator-facing conclusions go only into:
