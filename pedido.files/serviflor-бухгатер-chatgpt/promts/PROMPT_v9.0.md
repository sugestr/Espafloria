...
v9.0-lite change summary:
- Removes heavy reconciliation report.
- Replaces 4_reconciliation_report.xlsx with lightweight 4_import_control_summary.xlsx.
- Keeps all critical validation gates.
...
- Keeps supplier enrichment on PO line only if confirmed as purchase.order.line Studio fields.
...
- keep values in audit_full and 4_import_control_summary.xlsx;
...
- put them in 4_import_control_summary.xlsx only if compact;
