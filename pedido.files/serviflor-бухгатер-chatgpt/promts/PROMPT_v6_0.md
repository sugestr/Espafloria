...
Changes vs v4.6:
1. Output ZIP must be flat and simple.
2. Final answer must be short and practical.
3. Add short human summary and optional Odoo chatter text.
4. Do not create complex nested ZIP/manifest structure unless explicitly asked.
