...
v8.5 change summary:
- Uses confirmed Odoo 19.3 import-compatible XLSX headers.
- XLSX headers use no spaces around "/".
- Odoo preview may display mapped fields with spaces around "/"; this is correct.
- Critical price field:
  XLSX column: Order Lines/Unit Price
  Odoo preview: Order Lines / Unit Price
  Technical target: order_line/price_unit
- Promised Date is confirmed and used.
- Expected Arrival is not mandatory.
- Keeps strict numeric Database ID gate.
- Keeps Odoo-actual UoM / Price Gate.
- Keeps PO clean sheet pure.
- Keeps supplierinfo learning separate.
- Keeps flat ZIP output.
- Keeps simple Russian Odoo chatter text.
- NEW: Primary receipt warehouse is dynamic, not always Plaza.
- NEW: Internal transfers are generated only for real movements from primary receipt warehouse to other stores.
- NEW: If all accepted stock stays in primary receipt warehouse, no transfer files are generated.
...
====================================================================
10. MAPPING_CHECK_REQUIRED SHEET
====================================================================
...
1. Order Lines/Product/External ID
...
====================================================================
12. ODOO-ACTUAL PRICE / AMOUNT GATE
====================================================================
...
- final response must explicitly warn:
  “Before accepting import, verify that Order Lines/Unit Price maps to Order Lines / Unit Price and that Odoo line Amounts equal factura subtotals.”

====================================================================
13. PO QUANTITY / PRICE / UOM POLICY
====================================================================
...
====================================================================
14. UOM DATABASE ID GATE — STRICT
====================================================================
...
====================================================================
17. PURCHASE ORDER IMPORT FORMAT — PURE PO
====================================================================
...
====================================================================
19. INTERNAL TRANSFER DECISION POLICY
====================================================================
...
====================================================================
20. INTERNAL TRANSFER IMPORT FORMAT
====================================================================
...
====================================================================
27. HUMAN SUMMARY + ODOO CHATTER TEXT
====================================================================
...
4. Детали по спорным / важным строкам.
5. [log] technical summary for future robots.
...
- known Odoo actual Unit Price differs from intended generated PO Unit Price;
...
13. Supplierinfo learning:
   - rows generated;
   - conflicts/blockers.
14. ODOO / PEDIDO LOG TEXT:
   copy-paste-ready Russian block.
15. Optional separate XLSX links.
16. Short Odoo import order.
