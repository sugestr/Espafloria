...
v8.1 change summary:
- PO clean sheet hardened: only real PO import fields by default.
- Supplierinfo/audit/helper fields removed from PO clean sheet.
- Studio item_comment field clarified.
- Untitled policy clarified.
- Pack UoM import-safety clarified.
- Supplierinfo price/UoM consistency enforced.
- Product / External ID is authoritative in supplierinfo import.
- Final ZIP remains flat and simple.
- Final response must include simple Russian Odoo chatter text.
...
7. Wrong product match is worse than unmatched.

8. Do not deliver clean final import files if red blockers remain.
...
- Order Lines / Unit / Database ID = pack/purchase UoM if known and import-safe
...
Incorrect if Odoo recalculates:
- Quantity = 20
- Unit Price = 2.61
- UoM = Units
...
9. Supplierinfo learning:
   - rows generated;
   - conflicts/blockers.
10. Odoo import warning:
   - Excel subtotal PASS is not enough;
   - after real Odoo import, compare Pedido total with factura.
11. ODOO / PEDIDO LOG TEXT:
   copy-paste-ready Russian block.
12. Optional separate XLSX links.
13. Short Odoo import order.
